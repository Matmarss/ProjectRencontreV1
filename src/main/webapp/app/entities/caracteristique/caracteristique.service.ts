...
type EntityResponseType = HttpResponse<ICaracteristique>;
type EntityArrayResponseType = HttpResponse<ICaracteristique[]>;

@Injectable({ providedIn: 'root' })
export class CaracteristiqueService {
  public resourceUrl = SERVER_API_URL + 'api/caracteristiques';
  ...
  update(caracteristique: ICaracteristique): Observable<EntityResponseType> {
    return this.http.put<ICaracteristique>(this.resourceUrl, caracteristique, { observe: 'response' });
  }
